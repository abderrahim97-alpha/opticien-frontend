...
const MontureEdit: React.FC = () => {
  ...
  const handleFinalSubmit = async () => {
    ...
    try {
      ...
      setSuccess(response.data.message || 'Monture mise à jour avec succès ! Redirection...');
        ...
        return (
          <div className="space-y-4 animate-fadeIn">
            <div className="text-center mb-4">
              ...
              <p className="text-blue-200 text-sm">Modifiez les informations essentielles</p>
            </div>
        ...
        return (
          <div className="space-y-4 animate-fadeIn">
            <div className="text-center mb-4">
              ...
              <p className="text-blue-200 text-sm">Mettez à jour les détails de la monture</p>
            </div>
        ...
        return (
          <div className="space-y-4 animate-fadeIn">
            <div className="text-center mb-4">
              ...
              <p className="text-blue-200 text-sm">Modifiez la description du produit</p>
            </div>
        ...
        return (
          <div className="space-y-4 animate-fadeIn">
            <div className="text-center mb-4">
              ...
              <p className="text-blue-200 text-sm">Gérez les photos de votre monture</p>
            </div>
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
                  {existingImages.map((img, index) => (
                    <div key={img["@id"]} className="relative group">
                      ...
                      <p className="text-xs text-blue-200 mt-1 truncate">{img.imageName}</p>
                    </div>
                  ))}
                </div>
              </div>
            ...
            {/* New Image Upload */}
            <div>
              <h3 className="text-xs sm:text-sm font-bold text-blue-200 mb-3">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 gap-2 sm:gap-3">
                  {newImages.map((img, index) => (
                    <div key={index} className="relative group">
                      ...
                      <div className="absolute top-2 left-2 bg-green-500 text-white text-xs px-2 py-0.5 rounded font-bold">
                        Nouveau
                      </div>
            ...
            <div className="backdrop-blur-xl bg-gradient-to-r from-blue-500/20 to-indigo-500/20 border border-blue-400/50 rounded-lg p-4 sm:p-6">
              ...
              {imagesToDelete.length > 0 && (
                <div className="mt-4 pt-4 border-t border-blue-300/30">
                  <p className="text-sm text-red-300 font-bold flex items-center">
    ...
    return (
      <div className="relative min-h-screen overflow-hidden bg-gradient-to-br from-indigo-950 via-blue-950 to-slate-900 flex items-center justify-center p-4">
        ...
        <div className="relative text-center">
          <svg className="animate-spin h-12 w-12 sm:h-16 sm:w-16 text-blue-400 mx-auto mb-4" fill="none" viewBox="0 0 24 24">
            <circle className="opacity-25" cx="12" cy="12" r="10" stroke="currentColor" strokeWidth="4"></circle>
            <path className="opacity-75" fill="currentColor" d="M4 12a8 8 0 018-8V0C5.373 0 0 5.373 0 12h4zm2 5.291A7.962 7.962 0 014 12H0c0 3.042 1.135 5.824 3 7.938l3-2.647z"></path>
          </svg>
          <p className="text-blue-200 font-bold text-lg">Chargement des données...</p>
        </div>
      </div>
    );
  }
      ...
      <div className="relative w-full max-w-5xl mx-auto z-10">
        ...
        <div className="mb-6">
          <button
            ...
            className="group flex items-center mb-4 transition duration-200"
          >
            <div className="relative overflow-hidden">
              <div className="absolute inset-0 bg-gradient-to-r from-blue-600 to-indigo-600 rounded-lg blur opacity-50 group-hover:opacity-75 transition duration-300" />
              <div className="relative backdrop-blur-xl bg-white/10 border border-white/20 text-white py-2 px-4 rounded-lg font-bold transition duration-300 flex items-center text-sm">
          ...
          <div className="text-center">
            <h1 className="text-2xl sm:text-3xl lg:text-4xl font-black text-white mb-2">Modifier la Monture</h1>
            <p className="text-blue-200 text-sm sm:text-base">Mettez à jour les informations étape par étape</p>
          </div>
        </div>
