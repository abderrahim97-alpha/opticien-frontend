...
const MontureForm: React.FC = () => {
  ...
  // ========== FONCTION DE SOUMISSION SÉPARÉE ==========
  ...
  const handleKeyDown = (e: React.KeyboardEvent<HTMLFormElement>) => {
    if (e.key === 'Enter') {
      ...
      // Autoriser Entrée uniquement dans le textarea
  ...
  const handleSubmit = (e: React.FormEvent) => {
    e.preventDefault();
    // Ne rien faire - la soumission est gérée par le bouton
  };
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mt-2">Commençons par les informations essentielles</p>
            </div>
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mt-2">Précisez les détails de la monture</p>
            </div>
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mt-2">Décrivez votre produit en détail</p>
            </div>
        ...
        return (
          <div className="space-y-6 animate-fadeIn">
            <div className="text-center mb-6">
              ...
              <p className="text-gray-600 mt-2">Ajoutez des photos de qualité</p>
            </div>
            ...
            <div className="bg-gradient-to-r from-blue-50 to-indigo-50 border border-blue-200 rounded-lg p-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                ...
                <div>
                  ...
                  <p className="font-semibold text-gray-800">{uploadedImages.length} photo(s)</p>
                </div>
              </div>
            </div>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-indigo-50 py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="text-gray-600">Complétez les étapes pour créer votre monture</p>
        </div>
